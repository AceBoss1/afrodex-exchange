...
// tokens registry for mapping symbol to address (add remaining tokens as needed)
export const SUPPORTED_TOKENS = {
  ...
  T1C: { symbol: 'T1C', address: '0xa7C71d444bf9aF4bfEd2adE75595d7512Eb4DD39', decimals: 18 },
  ...
  LWBT: { symbol: 'AFDLT', address: '0xA03c34eE9fA0e8db36Dd9bF8D46631Bb25F66302', decimals: 18 },
  USDC: { symbol: 'USDC', address: '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', decimals: 18 },
  USDT: { symbol: 'USDT', address: '0xdAC17F958D2ee523a2206206994597C13D831ec7', decimals: 18 },
  DAI: { symbol: 'DAI', address: '0x9eC251401eAfB7e98f37A1D911c0AEA02CB63A80', decimals: 18 },
  WETH: { symbol: 'WETH', address: '0x6B175474E89094C44Da98b954EedeAC495271d0F', decimals: 18 },
  // ... add others
}
